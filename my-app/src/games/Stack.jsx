...
export default function Stack(){
  ...
  useEffect(()=>{
    ...
    function reset(){
      tower=[base];
      current={x:0,y:base.y-20,w:base.w,h:20,dir:1};
      h=0;
      setHeight(0)
    }
    ...
    const loop=()=>{
      ...
      x.fillStyle='#0b1a4a';
      x.fillRect(0,c.height-10,c.width,10);
      x.fillStyle='#7aa2ff';
      tower.forEach(b=>x.fillRect(b.x,b.y,b.w,b.h));
      x.fillStyle='#eaeaea';
  ...
  return (<div>
    <div className="controls">
      <span className="pill">Steuerung: <b>Space/Klick</b> = Block droppen</span>
      <span className="pill">Höhe: <span className="score">{height}</span></span>
