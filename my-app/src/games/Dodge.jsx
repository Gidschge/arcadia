...
export default function Dodge(){
  ...
  useEffect(()=>{
    let player={x:360-15,y:360-40,w:30,h:30},left=false,right=false,blocks=[],tick=0,s=0
    ...
    function spawn(){ blocks.push({x:Math.random()*(720-30),y:-20,w:20+Math.random()*40,h:20+Math.random()*20,s:2+Math.random()*3+s/300}) }
  ...
  return (<div>
    <div className="controls">
      <span className="pill">Steuerung: <b>← →</b></span>
